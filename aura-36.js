...
(() => {
    const baseGallery = [
        'wb1.webp','wb2.webp','wb3.webp','wb4.webp','wb5.webp','wb6.webp','wb7.webp',
        'wb8.webp','wb9.webp','wb10.webp','wb11.webp','wb12.webp','wb13.webp','wb14.webp',
        'wb15.webp','wb16.webp','wb17.webp','wb18.webp','wb19-2.webp','wb29.webp','wn21.webp'
    ].map(f => `images/aura-36/${f}`);
    ...
    const rooms = {
        single: {
            ...
            images: ['images/aura-36/single-sharing.jpg', ...baseGallery]
        },
        standard: {
            tag: 'Value',
            ...
            images: ['images/aura-36/standard-two-sharing.jpg', ...baseGallery]
        },
        premium: {
            tag: 'Premium',
            ...
            images: ['images/aura-36/premium-two-sharing.jpg', ...baseGallery]
        }
    };
    ...
    document.querySelectorAll('[data-room]').forEach(el => {
        el.addEventListener('click', (e) => {
            // If clicking a button/link inside a card that's NOT quickview, let it through
